...
from launch.actions import SetEnvironmentVariable, IncludeLaunchDescription, SetLaunchConfiguration
...
def generate_launch_description():
    ...
    limo_world_pkg_path = get_package_share_directory('limo_world')  # Replace with your package name
    
    # Path to the Gazebo launch file
    gz_launch_path = PathJoinSubstitution([pkg_ros_gz_sim, 'launch', 'gz_sim.launch.py'])

    # Path to the World file
    world_path = PathJoinSubstitution([limo_world_pkg_path, 'worlds', 'basic.world'])
